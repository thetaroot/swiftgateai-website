    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'SwiftGate AI — AI Employee Demo',
      },
    ],
    type: 'website',
    locale: 'de_DE',
...
export default function AIEmployeeDemoLayout({ children }: { children: React.ReactNode }) {
  return children;
}
