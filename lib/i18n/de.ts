...
export const de: Dictionary = {
    ...
    followUp: {
        title: 'Bevor wir Sie verbinden...',
        nextButton: 'Weiter',
        generateButton: 'E-Mail generieren',
        q1: 'Was für ein Projekt schwebt Ihnen vor?',
        q2: 'Für welches Unternehmen oder welche Organisation?',
        q3: 'Wie dringend ist das Vorhaben?',
        q3optSoon: 'Bald (Wochen)',
        q3optQuarter: 'Nächstes Quartal',
        q3optExploring: 'Nur informieren',
    },
    architecture: {
