export interface Dictionary {
    ...
    leadDemo: {
        ...
        introDisclaimer: string;
        introCta: string;
        scenarioEmailTitle: string;
        scenarioEmailDesc: string;
        scenarioInstagramTitle: string;
        scenarioInstagramDesc: string;
        scenarioWhatsappTitle: string;
        scenarioWhatsappDesc: string;
        scenarioSpamTitle: string;
        scenarioSpamDesc: string;
        sectionScoring: string;
        sectionPipeline: string;
        sectionNotifications: string;
        sectionAutoReply: string;
        sectionStats: string;
        pipelineNew: string;
        pipelineQualified: string;
        pipelineContacted: string;
        scoreHot: string;
        scoreWarm: string;
        scoreCold: string;
        idleTitle: string;
        idleSubtitle: string;
        crossoverCrm: string;
        crossoverReply: string;
        crossoverFiltered: string;
        statsScored: string;
        statsAvgTime: string;
        statsQualRate: string;
    };
}
