...
export const en: Dictionary = {
    ...
    portfolio: {
        ...
        projects: [
            ...
            },
            {
                ...
                description: 'An intelligent lead scoring and qualification system that processes inquiries from Email, Instagram, WhatsApp and web forms — scores them in real-time, enriches CRM data, and sends personalized auto-replies.',
                details: [
                    'The Lead AI Agent monitors multiple communication channels simultaneously. When a new message arrives — whether via email, Instagram DM, WhatsApp, or web form — it instantly analyzes the content, sender profile, and intent signals to generate a lead score from 0-100.',
                    'High-scoring leads (HOT, 80+) trigger immediate notifications to sales via Slack and SMS, with CRM entries enriched by company data. Warm leads (60-79) get routed to marketing with automated follow-up sequences. Cold leads and spam are silently filtered.',
                    'The system generates personalized auto-replies matching the channel tone — professional for email, friendly for Instagram, direct for WhatsApp. Templates adapt based on the lead score category and inquiry type, ensuring every prospect gets an appropriate response within seconds.',
                ],
                results: [
                    'Lead scoring in under 3 seconds — instant qualification without manual review',
                    'Multi-channel inbox unified — Email, Instagram, WhatsApp, Web Forms in one pipeline',
                    'Spam filtered automatically — 95%+ noise reduction, zero false positives on hot leads',
                    'Personalized auto-replies — channel-appropriate responses sent within seconds',
                ],
                year: '2026',
    ...
    chat: {
        ...
        resumeChat: 'Continue your conversation',
    ...
    contact: {
        ...
        aiBtn: {
            ...
            desc: 'Automatically generates a professional project request — from our chat or from scratch.',
            cta: 'Generate Now',
        },
    },
    footer: {
    ...
    ticket: {
        ...
        successContinue: 'Feel free to keep chatting if you have any more questions.',
        privacyNote: 'Your data is only used for this inquiry.',
        errorMessage: 'Something went wrong. Please contact us at hello@swiftgateai.de.',
    },
    followUp: {
        title: 'Tell us briefly about your project',
        titleWithContext: 'Almost there',
        nextButton: 'Next',
        generateButton: 'Generate Email',
        q1: 'What do you have in mind?',
        q1Hint: 'No pitch needed — just describe it in your own words.',
        q2: 'Who is this project for?',
        q2Hint: 'Company name or industry is enough.',
        q3: 'What does your timeline look like?',
        q3Hint: 'Helps us plan the right pace.',
        q3optSoon: 'Soon — within weeks',
        q3optQuarter: 'No rush — next quarter',
        q3optExploring: 'Just exploring for now',
    },
    architecture: {
    ...
    leadDemo: {
        title: 'Lead AI Agent',
        subtitle: 'AI-powered lead scoring, qualification & auto-reply',
        back: 'Back',
        tabMessages: 'Messages',
        tabDashboard: 'Dashboard',
        inputPlaceholder: 'Type a message...',
        introTitle: 'Welcome to the Lead Agent Demo',
        introText: 'See how an AI agent scores incoming leads in real-time — across Email, Instagram, WhatsApp and web forms. It qualifies prospects, updates the CRM, notifies your team, and sends personalized auto-replies.',
        introDisclaimer: 'This is a pre-scripted demo. No real API calls are made and no tokens are consumed.',
        introCta: 'Start Demo',
        scenarioEmailTitle: 'New Email Inquiry',
        scenarioEmailDesc: 'Manufacturing company asks about AI automation',
        scenarioInstagramTitle: 'Instagram DM',
        scenarioInstagramDesc: 'Designer asks about pricing casually',
        scenarioWhatsappTitle: 'WhatsApp Enterprise',
        scenarioWhatsappDesc: 'COO with urgent board deadline',
        scenarioSpamTitle: 'Spam Filter',
        scenarioSpamDesc: 'Generic sales pitch gets filtered',
        ...
        scoreWarm: 'WARM',
        scoreCold: 'COLD',
        idleTitle: 'Waiting for incoming leads...',
        idleSubtitle: 'System ready',
        crossoverCrm: 'Show CRM',
        crossoverReply: 'Change reply',
        crossoverFiltered: 'Show filtered',
        statsScored: 'scored',
        statsAvgTime: 'avg',
